...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      `frame-src 'self' https://*.${PLATFORM_DOMAIN} https://*.${APP_DOMAIN} https://*.sslip.io http://localhost${process.env.NEXT_PUBLIC_LIMA_PREVIEW_PORT ? ` http://localhost:${process.env.NEXT_PUBLIC_LIMA_PREVIEW_PORT}` : ""}`,
