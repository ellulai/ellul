...
<Cta
  ...
  body="Keep your Claude Code, Cursor, Codex, OpenCode, or Grok CLI. Run it on a persistent workstation that gates the dangerous parts. Twenty dollars a month for Hobby, fifty for Pro."
