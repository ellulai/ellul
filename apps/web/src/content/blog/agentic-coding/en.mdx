...
<Cta
  ...
  body="Ellul gives every agent (Claude Code, Codex, OpenCode, Cursor's CLI, Grok) its own persistent workstation, parallel-capable, with passkey-gated real-credential operations and full audit. $20/month Hobby, $50/month Pro."
