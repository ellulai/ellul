...
<Cta
  ...
  body="Ellul is a persistent-workstation runtime designed for coding agents that hold state across sessions. Bring Claude Code, Codex, OpenCode, Cursor's CLI, or Grok; the workstation keeps your dependencies hot and your agent's context warm."
