...
Question B: I want a stronger autonomous agent. What you actually want is an agent that drives multi-step work better than Cursor's chat panel can. Claude Code, Codex, OpenCode, Devin all sit here. The alternative is on the agent axis. The editor (or absence of editor) is secondary.
...
<Cta
  ...
  body="Ellul is a workstation runtime where you bring the agent (Claude Code, Codex, OpenCode, Cursor's CLI), the model key, and your existing editor. Same Cursor; different place for the agent to live. $20/mo Hobby, $50/mo Pro."
