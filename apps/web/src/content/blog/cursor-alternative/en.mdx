...
<Cta
  ...
  body="Ellul is a workstation runtime where you bring the agent (Claude Code, Codex, OpenCode, Cursor's CLI, Grok Build), the model key, and your existing editor. Same Cursor; different place for the agent to live. $20/mo Hobby, $50/mo Pro."
