...
2. **Provision a workstation.** A persistent sandbox boots in roughly ninety seconds. OpenCode is pre-installed alongside Claude Code, Codex, Cursor's CLI, and Grok.
