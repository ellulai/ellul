...
- **Anthropic-managed cloud.** If you specifically want Anthropic to host the agent, that is their cloud, not ours. Ellul is model-agnostic and runs Codex, Cursor's CLI, OpenCode, and Grok Build on the same primitive.
</Callout>
