...
// pingdotgg/t3code@b0b7b38 apps/web/src/components/chat/ExpandedImageDialog.tsx
...
export const ExpandedImageDialog = memo(function ExpandedImageDialog({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={tChat("expandedImage.previewAria")}
    >
      <button
        type="button"
        className="absolute inset-0 z-0 cursor-zoom-out"
        aria-label={tChat("expandedImage.closeAria")}
        onClick={onClose}
      />
      {preview.images.length > 1 && (
        <Button
          ...
          aria-label={tChat("expandedImage.previousAria")}
      ...
      {preview.images.length > 1 && (
        <Button
          ...
          aria-label={tChat("expandedImage.nextAria")}
          onClick={() => navigateImage(1)}
        >
