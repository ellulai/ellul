...
// pingdotgg/t3code@b0b7b38 apps/web/src/composerDraftStore.ts
...
export function deriveEffectiveComposerModelState(input: {
  ...
  // Resolve persisted model so stale entries (paid/disconnected) fall back
  // to one in the live connected list — keeps picker display and dispatch
  // in sync.
