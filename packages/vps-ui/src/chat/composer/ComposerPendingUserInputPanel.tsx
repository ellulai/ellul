...
// pingdotgg/t3code@b0b7b38 apps/web/src/components/chat/ComposerPendingUserInputPanel.tsx

import { type ApprovalRequestId } from "@ellul.ai/types";
import { memo, useEffect, useEffectEvent, useRef } from "react";
import { type PendingUserInput } from "../lib/session-logic";
import {
  ...
  return (
    <div className="px-4 py-3 sm:px-5">
      ...
      {activeQuestion.multiSelect ? (
        <p className="mt-1 text-xs text-muted-foreground/65">{tChat("composer.selectOptionsHint")}</p>
      ) : null}
