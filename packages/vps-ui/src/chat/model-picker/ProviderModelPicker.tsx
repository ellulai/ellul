...
export const ProviderModelPicker = memo(function ProviderModelPicker(
  ...
  const selectedModel =
    props.models.find((option) => option.slug === props.model) ?? props.models[0];
  ...
  const setIsMenuOpen = (open: boolean) => {
    ...
    if (props.open === undefined) setUncontrolledIsMenuOpen(open);
  };
  ...
  return (
    ...
    >
        ...
        render={
          <Button
            ...
            className={cn(
              ...
              props.compact ? "max-w-[168px] shrink-0" : "max-w-48 shrink sm:max-w-56 sm:px-3",
      ...
      <PopoverPopup
        align="start"
        className="border-0 bg-transparent p-0 shadow-none *:data-[slot=popover-viewport]:p-0"
      >
        <ModelPickerContent
          provider={props.provider}
          model={props.model}
          models={props.models}
          pinnedModelSlug={props.pinnedModelSlug}
