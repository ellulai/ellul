...
// pingdotgg/t3code@b0b7b38 apps/web/src/components/ui/toast.tsx
...
import { type ScopedThreadRef, type ThreadId } from "@ellul.ai/types";
import {
  CheckIcon,
  ChevronDownIcon,
  ChevronUpIcon,
...
export const ThreadIdContext = createContext<ScopedThreadRef | null>(null);
...
function CopyErrorButton({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      title={tChat("toast.copy.errorTitle")}
      type="button"
    >
...
function ToastExpandableSection({
  ...
  const expandLabel = labels.expand ?? tChat("toast.expandable.showDetails");
  const collapseLabel = labels.collapse ?? tChat("toast.expandable.hideDetails");
          ...
          return (
            ...
            >
              ...
              <div className={toastCornerDismissClass}>
                <button
                  aria-label={tChat("toast.dismissNotificationAria")}
...
export { stackedThreadToast } from "./toast-helpers";
export type { StackedThreadToastOptions } from "./toast-helpers";
