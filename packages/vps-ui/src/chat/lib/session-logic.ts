...
// pingdotgg/t3code@b0b7b38 apps/web/src/session-logic.ts
...
export const PROVIDER_OPTIONS: Array<{
  ...
  { value: "zeroclaw", label: "ZeroClaw", available: true },
  ...
  { value: "grokAgent", label: "Grok Build", available: true, pickerSidebarBadge: "new" },
];
