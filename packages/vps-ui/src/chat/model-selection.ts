...
// pingdotgg/t3code@b0b7b38 apps/web/src/modelSelection.ts
...
import { getComposerProviderState } from "./composer/composer-provider-registry";
import {
...
const PROVIDER_CUSTOM_MODEL_CONFIG: Record<ProviderKind, ProviderCustomModelConfig> = {
  ...
  zeroclaw: {
    provider: "zeroclaw",
    title: "ZeroClaw",
    description: "ZeroClaw is daemon-managed; this provider has no custom model slugs.",
    placeholder: "",
    example: "",
  },
  grokAgent: {
