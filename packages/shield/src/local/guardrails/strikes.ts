 ...
 *
 * Extracted from packages/vps/src/services/auth/sovereign-shield/src/services/guardrail-strikes.service.ts
 */
...
// Resets on: successful scan (agent fixed the code), TTL expiry, or daemon restart.
