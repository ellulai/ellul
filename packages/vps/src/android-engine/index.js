...
http://localhost:8443, http://127.0.0.1:8443 {
    ...
    handle /vps-config.js {
        ...
        respond ${"`"}window.__ELLUL_CONFIG__=${JSON.stringify({platformZone:"localhost",appZone:"ellul.app",consoleOrigin:"https://localhost:8443",wsOrigin:"https://localhost:8443",codeWsOrigin:"https://localhost:8443",codeWsPath:"/code-ws",disabledSessions:["claw"]})};${"`"} 200
    }
...
function setupFilesystem() {
  ...
  const CONSOLE_ORIGIN = "https://localhost:8443";
  const originFiles = {
