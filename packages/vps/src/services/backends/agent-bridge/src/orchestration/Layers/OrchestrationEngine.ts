...
// pingdotgg/t3code@b0b7b38 apps/server/src/orchestration/Layers/OrchestrationEngine.ts
...
function commandToAggregateRef(command: OrchestrationCommand): {
  readonly aggregateKind: "project" | "thread" | "sandbox";
  readonly aggregateId: ProjectId | ThreadId | SandboxAggregateId;
} {
  switch (command.type) {
    case "project.create":
