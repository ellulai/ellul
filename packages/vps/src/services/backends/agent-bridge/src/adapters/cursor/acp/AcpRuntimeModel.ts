...
// ported from
// pingdotgg/t3code@b0b7b38 apps/server/src/provider/acp/AcpRuntimeModel.ts

import type * as EffectAcpSchema from "../../vendor/t3code/effect-acp/schema";
import { deriveToolActivityPresentation } from "../../../shared/toolActivity";
import type { ToolLifecycleItemType } from "@ellul.ai/types";
