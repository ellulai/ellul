...
const AUDIT_LOG = '/var/log/ellul/audit.jsonl';
const CHAIN_HEAD_FILE = '/etc/ellul/shield-data/audit-chain-head';
const SIGNING_KEY = '/etc/ellul-bootstrap/heartbeat.key'; // Reuse Ed25519 key
