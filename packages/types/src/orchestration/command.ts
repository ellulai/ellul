...
import { ChatAttachment, UploadChatAttachment } from "../chat/attachment";
import {
  ApprovalRequestId,
  CheckpointRef,
  CommandId,
...
import { OrchestrationCheckpointFile, OrchestrationCheckpointStatus } from "./checkpoint";
import { ProjectScript } from "./project";
import {
...
export const SandboxModelPinCommand = Schema.Struct({
  type: Schema.Literal("sandbox.model.pin"),
  commandId: CommandId,
...
export const SandboxModelUnpinCommand = Schema.Struct({
  type: Schema.Literal("sandbox.model.unpin"),
  commandId: CommandId,
  provider: ProviderKind,
  createdAt: IsoDateTime,
});
...
export const DispatchableClientOrchestrationCommand = Schema.Union([
  ...
  SandboxModelPinCommand,
  SandboxModelUnpinCommand,
]);
